...
class Engine_Db_Adapter_Mysql extends Zend_Db_Adapter_Abstract
{
    ...
    public function listTables()
    {
        ...
        if(false != ($rs = mysql_query($query, $this->getConnection()))) {
    ...
    public function describeTable($tableName, $schemaName = null)
    {
         ...
         */
        if (false != ($queryResult = mysql_query($sql, $this->getConnection()))) {
    ...
    private function _throwException($message=null)
    {
        ...
        if( $message === null ) {
            if( is_resource($this->_connection) ) {
              ...
              $message = mysql_error()." (".mysql_errno().")";
            }
        }
    ...
    {
        return (string) mysql_insert_id($this->getConnection());
    }
    ...
    {
        return mysql_get_server_info($this->getConnection());
    }
