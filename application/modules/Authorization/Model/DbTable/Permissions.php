 ...
 * @version    $Id: Permissions.php 7299 2010-09-06 06:08:27Z john $
 * @author     John
 */
  ...
  implements Authorization_Model_AdapterInterface
{
  ...
  public function isAllowed($resource, $role, $action)
  {
    ...
    //  Engine_Exception::getLog()->log('String role permissions checking should query Authorzation_Model_DbTable_Allow directly.', Zend_Log::WARN);
    //}
